    ...
    while cap.isOpened():
        ...
        try: 
            if len(sequence) == 30:
                ...
                if actions[np.argmax(res)] == 'A':
                    print("its a nice")
                    text_to_speech("its a nice")
                if actions[np.argmax(res)] == 'B':
                    print("very good morning")
                    text_to_speech("very good morning")
                if actions[np.argmax(res)] == 'C':
                    print("which is your speaking language")
                    text_to_speech("which is your speaking language")
